<template>
  <li class="ms-md-4 nav-item position-relative">
    <svg
      id="moon"
      :class="`position-absolute theme-toggle ${moonClass}`"
      @click="themeToggle()"
    ...
    <svg
      ...
      fill="none"
    >
      <circle cx="12" cy="12" r="3.5" stroke="#38b6ff" />
      <path d="M12 5V3" stroke="#38b6ff" stroke-linecap="round" />
      <path d="M12 21V19" stroke="#38b6ff" stroke-linecap="round" />
      <path
      ...
      <path
        ...
        stroke-linecap="round"
      />
      <path d="M19 12L21 12" stroke="#38b6ff" stroke-linecap="round" />
      <path d="M3 12L5 12" stroke="#38b6ff" stroke-linecap="round" />
      <path
...
export default {
  ...
  methods: {
    themeToggle() {
      this.moonClass = this.moonClass == "opacity-0" ? "" : "opacity-0";
      this.sunClass = this.sunClass == "opacity-0" ? "" : "opacity-0";
